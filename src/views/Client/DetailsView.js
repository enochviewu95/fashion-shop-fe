...
export default function DetailsView() {
  ...
  useEffect(() => {
    getData(`/shop/api/get-product/${id}`)
      .then((result) => {
        if (!result) {
          return;
        }
  ...
  return product ? (
    <div className={lightBackground}>
      <div className="pt-6">
        <div className="mx-auto px-4 grid-cols-1 mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-10 lg:px-3">
          ...
          {/* Product info */}
          <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-1 lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
    ...
    <div className={`${lightBackground} min-h-screen`}></div>
  );
}
